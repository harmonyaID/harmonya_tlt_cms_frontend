export const MDLogout: string = 'modalLogout'
export const MDTokenExpired: string = 'modalTokenExpired'

// Modal General
export const MDGeneralServiceApp = 'modalGeneralServiceApp'
export const MDGeneralCheckOnu: string = 'modalGeneralCheckOnu'
export const MDGeneralCheckCoverage: string = 'modalGeneralCheckCoverage'
export const MDGeneralSearchServiceLocation: string =
    'modalGeneralSearchServiceLocation'
export const MDGeneralAdvanceFilter: string = 'modalGeneralAdvanceFilter'
export const MDGeneralRemove: string = 'modalGeneralRemove'
export const MDGeneralFilterMaxThreeMonth: string =
    'modalGeneralFilterMaxThreeMonth'
