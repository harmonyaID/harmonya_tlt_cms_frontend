import { getStaticAvailabilityType } from '@/service/api/propertySettingGeneral.api.ts'
...
const configUseStore = createStoreWithAPI(getStaticAvailabilityType)

const useStaticPropertyAvailabilityTypeStore = (
...
export default useStaticPropertyAvailabilityTypeStore
