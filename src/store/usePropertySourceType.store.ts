import { apiPropertySourceType } from '@/service/api/propertySettingGeneral.api.ts'
...
const configUseStore = createStoreWithAPI(() =>
    apiPropertySourceType.list({ page: 0 }),
)

const usePropertySourceType = (
...
export default usePropertySourceType
