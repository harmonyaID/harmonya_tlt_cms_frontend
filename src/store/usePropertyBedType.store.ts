import { apiPropertyBedType } from '@/service/api/propertySettingGeneral.api.ts'
...
const configUseStore = createStoreWithAPI(() =>
    apiPropertyBedType.list({ page: 0 }),
)

const usePropertyBedTypeStore = (
...
export default usePropertyBedTypeStore
