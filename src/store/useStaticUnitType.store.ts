import {getStaticUnitType} from "@/service/api/propertySettingGeneral.api.ts";
...
const configUseStore = createStoreWithAPI(getStaticUnitType)

const useStaticUnitTypeStore = (passConfig: DefaultConfigCreatStoreType = {}) => {
    return {
...
export default useStaticUnitTypeStore
