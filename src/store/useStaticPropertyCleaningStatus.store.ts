import { getStaticCleaningStatus } from '@/service/api/propertySettingGeneral.api.ts'
...
const configUseStore = createStoreWithAPI(getStaticCleaningStatus)

const useStaticPropertyCleaningStatusStore = (
...
export default useStaticPropertyCleaningStatusStore
