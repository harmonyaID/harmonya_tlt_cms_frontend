import { getStaticGuestySyncStatus } from '@/service/api/propertySettingGeneral.api.ts'
...
const configUseStore = createStoreWithAPI(getStaticGuestySyncStatus)

const useStaticPropertyGuestySyncStatusStore = (
...
export default useStaticPropertyGuestySyncStatusStore
