...
const SelectOptionBoatType = (props: SelectOptionGeneralProps) => {
    const uniqueId = useId()
    const ctx = useHookContextForm()

    const { __list } = useBoatTypeStore({ isFormatList: false })
    ...
    const myId = id || 'select-boat-type' + name + useId()
...
export default SelectOptionBoatType
