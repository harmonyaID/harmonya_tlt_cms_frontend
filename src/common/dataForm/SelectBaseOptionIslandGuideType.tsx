...
const SelectBaseOptionIslandGuideType = (props: SelectBaseOptionProps) => {
    const { __list, __isLoading } = useDataListHook({
        urlAPI: ({ search }) =>
            apiIslandGuideType.list(
                { search, page: 0 },
                'tcSelectBaseOptionIslandGuideType',
            ),
    })
...
export default SelectBaseOptionIslandGuideType
