...
import useCountryStore from '@/store/useCountry.store.ts'

const SelectOptionCountry = (props: SelectOptionGeneralProps) => {
    ...
    const myId = id || 'select-option-access' + name + useId()
