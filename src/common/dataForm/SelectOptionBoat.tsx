...
import useBoatStore from '@/store/useBoat.store.ts'

const SelectOptionBoat = (props: SelectOptionGeneralProps) => {
    const uniqueId = useId()
    const ctx = useHookContextForm()

    const { __list } = useBoatStore({ isFormatList: false })
    ...
    const myId = id || 'select-boat' + name + useId()
...
export default SelectOptionBoat
