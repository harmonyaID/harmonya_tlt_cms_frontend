...
const SelectOptionContactFormType = (props: SelectOptionGeneralProps) => {
    ...
    const myId = id || 'select-contact-form-type' + name + useId()
...
export default SelectOptionContactFormType
