...
const IslandGuideTypePage = () => {
    const {
        ...
        __handleToEdit,
        __handleToTrash,
    } = useIslandGuideTypeMainHook({ urlAPI: apiIslandGuideType.list })
    ...
    const {
        ...
        __handleSetDetail,
        __handleCloseDetail,
    } = useIslandGuideTypeDetailOffCanvasHook()
        ...
        <>
            ...
            <CreatePortalLayout>
                <ConfirmRemoveListLogic
                    ...
                    configHandle={{
                        urlAPI: () =>
                            apiIslandGuideType.delete(dataForRemove.id),
                        callBack: () => {
...
export default IslandGuideTypePage
