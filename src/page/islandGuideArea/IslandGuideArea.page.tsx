...
import { MDExCategoryRemove, MDGeneralRemove } from '@/config/modal.config.ts'
...
const IslandGuideAreaPage = () => {
    const {
        ...
        __handleToEdit,
        __handleToTrash,
    } = useIslandGuideAreaMain({ urlAPI: apiIslandGuideArea.list })
    ...
    const {
        ...
        __handleSetDetail,
        __handleCloseDetail,
    } = useIslandGuideAreaDetailOffCanvasHook()
        ...
        <>
            ...
            <CreatePortalLayout>
                <ConfirmRemoveListLogic
                    ...
                    configHandle={{
                        urlAPI: () =>
                            apiIslandGuideArea.delete(dataForRemove.id),
                        callBack: () => {
...
export default IslandGuideAreaPage
