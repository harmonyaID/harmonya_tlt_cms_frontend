...
import useContentIslandGuideDetail from '@/page/contentIslandGuide/hook/useContentIslandGuideDetail.hook.ts'
    ...
    return (
        <>
            ...
            <div className="row mb-4 g-3 align-items-md-center">
                <div className="col">
                    <PageTitle title="Island Guide Detail" />
                </div>
            ...
            <LoadingStatePreviewData isLoading={__isLoading} data={__detail}>
                <div className="vstack gap-3">
                    ...
                    <CardNavTab
                        tabs={[
                            objectTab(
                                'Island Guide Information',
                                'tabISlandGUideInformation',
                            ),
