...
const ContentOfferTrashPage = () => {
    const {
        ...
        // ---- Change Page ----
        __handleToMain,
    } = useContentOfferMainHook({ urlAPI: getOfferTrash, isTrash: true })
    ...
    const {
        ...
        urlAPIRestore: restoreOffer,
        urlAPIPermanentRemove: permanentDeleteOffer,
        actions: {
...
export default ContentOfferTrashPage
