...
import useContentOfferDetail from '@/page/contentOffer/hook/useContentOfferDetail.hook.ts'

const ContentOfferDetailPage = () => {
    const {
        __id,
        __detail,
        __isLoading,
...
export default ContentOfferDetailPage
